...
import { Box, Typography, CircularProgress, Divider, Container, Stack } from '@mui/material';
...
export default function EventDetailPage({ params }: { params: Promise<{ eventId: string }> }) {
  ...
  const { fetchById, currentEvent, deleteEvent, updateEvent, fieldErrors, isLoading } =
    useEventsStore();
