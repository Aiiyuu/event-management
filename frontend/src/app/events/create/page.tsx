...
import { EventFormFields, EventCategory } from '@/types/events';
...
export default function CreateEventPage() {
  ...
  const initialState: Partial<EventFormFields> = {
    title: '',
    description: '',
    location: '',
  ...
  const [formState, setFormState] = useState<Partial<EventFormFields>>(initialState);
